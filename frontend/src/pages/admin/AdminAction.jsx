...
const AdminActions = () => {
  ...
  const fetchAdminMap = useCallback(async () => {
    try {
      ...
      if (res.data.success) {
        const formattedMap = (res.data.admins || []).reduce((acc, admin) => {
          acc[admin.appwriteId] = {
            name: admin.name,
            email: admin.email,
            status: admin.status,
            emailVerification: admin.emailVerification,
            createdAt: admin.createdAt,
          };
          return acc;
        }, {});
        setAdminMap(formattedMap);
  ...
  return (
    <>
      ...
      <div className="relative min-h-screen">
        {/* Content wrapper */}
        <div className="relative p-4 sm:p-6 min-h-screen bg-gray-50/80 dark:bg-gray-900/80">
          ...
          {showForm && (
            <form
              ...
              className="bg-white/80 p-4 rounded-lg shadow mb-6 space-y-4"
            >
              <div>
                ...
                >
                  ...
                  {Object.entries(adminMap).map(([id, admin]) => (
